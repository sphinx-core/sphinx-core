...
#pragma warning(disable : 4996) // sprintf unsafe warning out
...
int TimeTest1()
{
	...
	unsigned long numOfTrials = (unsigned long) 1e2; // for debug only
	unsigned long i;
...
int TimeTest2()
{
	...
	HashReturn exitCode;
	unsigned long numOfTrials = (unsigned long) 1;
	unsigned long i;
