This directory contains the optimized implementation for 64bit processors.
Unfortunately due to time constraints this is the exact copy of the 32bit
optimized version.
	- README_64bit.txt 				This file
	...
	- Optimized64.vcproj			The project file in VS2005 format. Note that in the RELEASE all the compilation
